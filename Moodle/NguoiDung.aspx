<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="NguoiDung.aspx.cs" Inherits="Moodle.NguoiDung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:LinqDataSource ID="LinqDataSourceUser" runat="server" 
        ...
        Select="new (MaSV, Ho, Ten, Id, MaLop, Lop)" Where="MaLop == @MaLop">
        <WhereParameters>
